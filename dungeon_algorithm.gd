...
func _create_rooms_and_anchors(grid: Array, grid_size_x: int, grid_size_y: int, list_x: Array, list_y: Array, room_flags: DungeonData.RoomFlags) -> void:
	var room_number := 0
...
func _generate_extra_hallways(grid: Array, grid_size_x: int, grid_size_y: int, num_extra_hallways: int) -> void:
	...
	for _i in range(num_extra_hallways):
		...
		var cur_x := rng.rand_range(grid[x][y].start_x, grid[x][y].end_x)
		var cur_y := rng.rand_range(grid[x][y].start_y, grid[x][y].end_y)
...
func _generate_standard_floor(grid_size_x: int, grid_size_y: int, floor_props: DungeonData.FloorProperties) -> void:
	...
	_create_rooms_and_anchors(grid, grid_size_x, grid_size_y, list_x, list_y, floor_props.room_flags)
